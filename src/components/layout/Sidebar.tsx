...
import { LayoutGrid, BarChart2, RefreshCcw, Ban, CheckCircle, Download, Megaphone, Settings, HelpCircle, FileText, Package } from 'lucide-react';
...
const mainNavigation = [
  ...
  { name: 'Preview Deadstock', href: '/preview-deadstock', icon: Package },
